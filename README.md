...
I came up through networking and systems administration, got into Site Reliability Engineering (SRE) at **LinkedIn** running Hadoop infrastructure across 10,000+ physical servers and multiple datacenters, then founded the security engineering team at **CircleCI** after working my way up from Staff SRE to founding the macOS Team. Data infrastructure has been the constant thread through all of it. Big data pipelines, observability stacks, metrics systems — name it and I’ve probably touched it.

I’m currently **Head of Engineering at [VoiceBrain AI](https://www.voicebrain.ai)**, leading across product, platform, SRE, and DevOps. Shipping AI products, staying hands-on in architecture and code, and building the kind of team that doesn’t need me to be in every room.
...
- &#127794; Long walks in the woods — thinking optional
